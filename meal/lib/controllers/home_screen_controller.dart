...
class HomeScreenController extends GetxController {
  ...
  RxList<Category> availableCategories = [
    Category(
      id: "c1",
      title: "Roman",
      image: "assets/images/c1.png",
      color: const Color.fromARGB(255, 52, 34, 255),
    ),
    Category(
      id: 'c2',
      title: 'Fast Bites',
  ...
  RxList<Meal> availableMeal = [
    Meal(
      id: "m1",
      categories: ["c1"],
      title: "Spaghetti",
      imageUrl:
          "https://www.inspiredtaste.net/wp-content/uploads/2020/02/Spaghetti-Meat-Sauce-Recipe-2-1200.jpg",
      ingredients: ["Pasta", "Tomato", "Meat", "Salt"],
      // ingredients: ["Pasta", "Tomato", "Meat", "Salt"],
      steps: ["Boil water", "Add pasta", "Cook meat sauce", "Mix and serve"],
      duration: 20,
  ...
  void toggleMealFavoriteStatus(Meal meal) {
    final mealIsFavorite = favouriteMeals.any((m) => m.id == meal.id);

    if (mealIsFavorite) {
      favouriteMeals.removeWhere((m) => m.id == meal.id);
    } else {
  ...
  bool isFavorite(Meal meal) {
    return favouriteMeals.any((m) => m.id == meal.id);
  }
}
